...
import { UploadFormTypes, VideoTypes } from '../../types/VideoTypes';
...
const EditForm: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        const clientCredentials = JSON.parse(session);
        ...
        fetch(`${process.env.EXPO_PUBLIC_API_URL}/videos/${id}/update`, {
            method: 'PUT',
            headers: {
                "Authorization": `Bearer ${clientCredentials.token}`
            },
            body: formData,
        })
            .then(async (data) => {
    ...
    return video && (
        <View style={styles.container}>
            <Text style={styles.signIn}>Edit</Text>
